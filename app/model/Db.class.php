...
//Database classs used for connecting the mySQL database
class Db {
  ...
  // Creates an instance of the databe to start the connection
  ...
  // gets the ID of the last inserted object
